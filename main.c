...
static t_defs	temp_defs_init(void)
{
	...
	def.mlx = mlx_init();
	def.north_wall_texture.img.inst = mlx_xpm_file_to_image(def.mlx, "./textures/n_wall_texture.xpm", &def.north_wall_texture.width, &def.north_wall_texture.height);
	...
	def.south_wall_texture.img.inst = mlx_xpm_file_to_image(def.mlx, "./textures/s_wall_texture.xpm", &def.south_wall_texture.width, &def.south_wall_texture.height);
	...
	def.west_wall_texture.img.inst = mlx_xpm_file_to_image(def.mlx, "./textures/w_wall_texture.xpm", &def.west_wall_texture.width, &def.west_wall_texture.height);
	...
	def.east_wall_texture.img.inst = mlx_xpm_file_to_image(def.mlx, "./textures/e_wall_texture.xpm", &def.east_wall_texture.width, &def.east_wall_texture.height);
